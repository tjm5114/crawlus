...
<body bgcolor="white"><p>
	...
	<tr><td colspan="3">
	 ...
	 <tr> 
	 <td colspan="1" align="left" valign="top"> <object type="text/plain"  data="checkid.do?action=displayfile&amp;subid=<%= listSubmitID %>&amp;ctype=txt&amp;file=bartour.txt" width="850" height="750"></object> </td> 

	 </tr>
	 <tr> 
	 <td colspan="1" align="left" valign="top"> <object type="image/png" data="checkid.do?action=displayfile&amp;subid=<%= listSubmitID %>&amp;ctype=png&amp;file=rplot.png"  width="960" height="960"></object> </td> 
