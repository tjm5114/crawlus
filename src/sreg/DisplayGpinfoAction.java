...
public class DisplayGpinfoAction extends DownloadAction {
    ...
    throws Exception {
        ...
        String filePath = resdir + File.separator + "process_graph.jpg"; 
        String contentType = "image/jpg";
        String fullFilePath = workdir + File.separator  +"results" + File.separator + "process_graph.jpg";
